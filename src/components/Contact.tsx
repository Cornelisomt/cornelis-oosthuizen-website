          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 space-y-4">
                <Button onClick={handleWhatsApp} className="w-full bg-green-500 hover:bg-green-600 flex items-center gap-2">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={4} required className="w-full" />
              </div>
